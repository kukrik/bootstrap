...
class Modal extends Panel
{
	...
	public function showHideButton($strButtonId, $blnVisible) {
		Application::executeControlCommand($this->ControlId,  $this->getJqSetupFunction(), 'showButton', $strButtonId, $blnVisible);
	}
	...
	public function setButtonStyle($strButtonId, $styles) {
		Application::executeControlCommand($this->ControlId,  $this->getJqSetupFunction(), 'setButtonCss', $strButtonId, $styles);
	}
	...
	public function alert_Close() {
		...
		Application::executeControlCommand($this->getJqControlId(), 'remove');
	}
	...
	public function open() {
		Application::executeControlCommand($this->ControlId, $this->getJqSetupFunction(), 'open', Application::PRIORITY_LOW);
	}
	...
	public function close() {
		Application::executeControlCommand($this->ControlId, $this->getJqSetupFunction(), 'close', Application::PRIORITY_LOW);
	}
